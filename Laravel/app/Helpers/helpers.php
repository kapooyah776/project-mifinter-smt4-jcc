...
function get_attachment_image_url_by_id($id, $size = null)
{
    ...
    switch ($size) {
        case "large":
            if (file_exists('public/assets/uploads/media-uploader/large-' . $image_details->path)) {
                $image_url = asset('assets/uploads/media-uploader/large-' . $image_details->path);
            }
            break;
        case "grid":
            if (file_exists('public/assets/uploads/media-uploader/grid-' . $image_details->path)) {
                $image_url = asset('assets/uploads/media-uploader/grid-' . $image_details->path);
            }
            break;
        case "thumb":
            if (file_exists('public/assets/uploads/media-uploader/thumb-' . $image_details->path)) {
                $image_url = asset('assets/uploads/media-uploader/thumb-' . $image_details->path);
            }
            break;
        default:
            if (is_numeric($id) && file_exists('public/assets/uploads/media-uploader/' . $image_details->path)) {
...
function get_attachment_image_by_id($id, $size = null, $default = false)
{
    ...
    if (!empty($image_details)) {
        ...
        $return_val['img_url'] = asset('public/assets/uploads/no-image.png');
    }
