...
class MediaUploadController extends Controller
{
    ...
    public function all_upload_media_file(Request $request)
    {
        ...
        foreach ($all_images as $image){
            if (file_exists('public/assets/uploads/media-uploader/'.$image->path)){
    ...
    public function delete_upload_media_file(Request $request)
    {
        ...
        if (file_exists('public/assets/uploads/media-uploader/'.$get_image_details->path)){
            unlink('public/assets/uploads/media-uploader/'.$get_image_details->path);
        }
        if (file_exists('public/assets/uploads/media-uploader/grid-'.$get_image_details->path)){
            unlink('public/assets/uploads/media-uploader/grid-'.$get_image_details->path);
        }
        if (file_exists('public/assets/uploads/media-uploader/large-'.$get_image_details->path)){
            unlink('public/assets/uploads/media-uploader/large-'.$get_image_details->path);
        }
        if (file_exists('public/assets/uploads/media-uploader/thumb-'.$get_image_details->path)){
            unlink('public/assets/uploads/media-uploader/thumb-'.$get_image_details->path);
        }
    }
