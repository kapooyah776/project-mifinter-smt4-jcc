...
use App\Http\Controllers\FightPredictionController;
/*
|--------------------------------------------------------------------------
| Web Routes
|--------------------------------------------------------------------------
...
//admin login  -- aslinya /login/admin dirubah menjadi /log/admin
Route::get('/adminin','Auth\LoginController@showAdminLoginForm')->name('admin.login');
Route::get('/adminin/forget-password','FrontendController@showAdminForgetPasswordForm')->name('admin.forget.password');
Route::get('/adminin/reset-password/{user}/{token}','FrontendController@showAdminResetPasswordForm')->name('admin.reset.password');
Route::post('/adminin/reset-password','FrontendController@AdminResetPassword')->name('admin.reset.password.change');
Route::post('/adminin/forget-password','FrontendController@sendAdminForgetPasswordMail');
Route::post('/adminout/admin','AdminDashboardController@adminLogout')->name('admin.logout');
Route::post('/adminin','Auth\LoginController@adminLogin');
...
Route::group(['middleware' => ['setlang','globalVariable']], function () {
    // predict fight
    Route::get('/predict-fight', [FightPredictionController::class, 'showForm'])->name('predict.form');
    Route::post('/predict-fight', [FightPredictionController::class, 'predict'])->name('predict.fight');
});