...
<div class="team-member-area padding-top-120 padding-bottom-20">
    <div class="container">
...
<?php if(!empty(get_static_option('home_page_service_section_status'))): ?>
    <section class="our-cover-area section-bg-1 padding-top-20 padding-bottom-20">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-6">
...
<div class="about-us-area padding-top-20 padding-bottom-20">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
...
<div class="our-gallery-area padding-top-20 padding-bottom-20">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="section-title desktop-center margin-bottom-50">
...
<div class="event-area-wrap padding-top-20 padding-bottom-20">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="section-title desktop-center margin-bottom-50">
...
<div class="new-area padding-top-20 padding-bottom-20">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="section-title desktop-center margin-bottom-50">
...
<?php endif; ?><?php /**PATH C:\xampp8.2.12\htdocs\jcc2\apt\resources\views/frontend/home-pages/home-09.blade.php ENDPATH**/ ?>