...
<div class="about-us-area padding-top-60 padding-bottom-20">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
...
<div class="team-member-area section-bg-1 padding-top-60 padding-bottom-20">
    <div class="container">
...
<?php if(!empty(get_static_option('home_page_service_section_status'))): ?>
    <section class="our-cover-area  padding-top-60 padding-bottom-20">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-6">
            ...
            <?php $__currentLoopData = $all_service; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-lg-2 col-md-3">
                    <div class="icon-box-three margin-bottom-10">
                        <?php if($data->icon_type == 'icon' || $data->icon_type == ''): ?>
                            <div class="icon content style-0<?php echo e($key+1); ?>">
                        ...
                        <?php else: ?>
                            <div class="img-icon content style-0<?php echo e($key+1); ?>">
...
<div class="service-area padding-bottom-20 alice-blue padding-top-20">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="section-title desktop-center margin-bottom-50">
...
<div class="recent-cause padding-top-20 padding-bottom-20">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="section-title desktop-center margin-bottom-50">
...
<div class="our-gallery-area section-bg-1 padding-top-60 padding-bottom-20">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="section-title desktop-center margin-bottom-50">
    ...
    <div class="gallery-masonry-init">
        ...
        <div class="gallery-masonry justify-content-center">
...
<div class="event-area-wrap padding-top-60 padding-bottom-20">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="section-title desktop-center margin-bottom-50">
...
<div class="counterup-area charity-home padding-top-20 padding-bottom-20"
...
<div class="testimonial-area charity-gray-bg padding-top-20 padding-bottom-20">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="section-title desktop-center margin-bottom-50">
...
<div class="new-area section-bg-1 padding-top-60 padding-bottom-20">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="section-title desktop-center margin-bottom-50">
...
<?php endif; ?><?php /**PATH C:\xampp8.2.12\htdocs\jcc\resources\views/frontend/home-pages/home-09.blade.php ENDPATH**/ ?>