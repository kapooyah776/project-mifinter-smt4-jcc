...
-->
 <footer class="footer-area home-page-<?php echo e(get_static_option('home_page_variant')); ?> <?php if(request()->routeIs('homepage')): ?> is-homepage <?php else: ?> is-homepage <?php endif; ?>">
...
</html><?php /**PATH C:\xampp8.2.12\htdocs\jcc\resources\views/frontend/partials/footer.blade.php ENDPATH**/ ?>