        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="left-side-content">
                    <h4 class="title"><?php echo e(get_static_option('home_page_01_'.get_user_lang().'_newsletter_area_title')); ?></h4>
...
</div><?php /**PATH C:\xampp\htdocs\jcc\apt\resources\views/frontend/partials/newsletter.blade.php ENDPATH**/ ?>